...
def get_args():
    ...
    # Model
    parser.add_argument("--model-name", default="EffiSeisM_dpk", type=str, metavar="MODEL_NAME",
                        help="model name: 'phasenet/eqtransformer/magnet/seist/EffiSeisM' (default: EffiSeisM_emg)")
    parser.add_argument("--checkpoint", default="./checkpoints/EffiSeisM_dpk_diting.pth", type=str, metavar="CHECKPOINT",
    ...
    # Random seed
    parser.add_argument("--seed", default=42, type=int, metavar="SEED",
    ...
    parser.add_argument("--log-step", default=50, type=int, metavar="log_step",
    ...
    # Save results
    parser.add_argument("--save-test-results", default=False, type=bool_, metavar="SAVE_TEST_RESULTS",
    ...
    # Dataset
    parser.add_argument("--data", default=r"/data/Diting50hz/", metavar="DATA", type=str,
                        help="path to dataset")
    parser.add_argument("--dataset-name", default="diting", type=str, metavar="DATASET_NAME",
    ...
    # Data augmentation
    parser.add_argument("--augmentation", type=bool_, default=False, metavar="AUGMENTATION",
    ...
    parser.add_argument("--mask-percent", default=0.8, type=int, metavar="MASK_PERCENT",
    ...
    parser.add_argument("--noise-percent", default=0.1, type=int, metavar="NOISE_PERCENT",
    ...
    parser.add_argument("--base-lr", default=1e-4, type=float, metavar="BASE_LR",
    ...
    # Val/Test
    parser.add_argument("--time-threshold", default=0.3, type=float, metavar="TIME_THRESHOLD",
...
def main_worker(args, device):
    ...
    if not (set(("train", "test")) & set(mode)):
        logger.error(f"`mode` must be 'train','test' or 'train_test', got '{args.mode}'")
        raise ValueError(f"`mode` must be 'train','test' or 'train_test', got '{args.mode}'")
